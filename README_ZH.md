![Maven Central](https://img.shields.io/maven-central/v/io.github.ayvytr/calendarview.svg?label=Maven%20Central)
...
这个库原作者不更新了，是Fork发布mavenCentral的
...
```
implementation 'com.haibin:calendarview:3.7.2'
```
